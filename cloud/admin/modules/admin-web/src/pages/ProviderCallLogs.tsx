...
export default function ProviderCallLogs() {
  ...
  return (
    <div>
      ...
      <Card><Tbl heads={['用户', '功能', 'Provider', '模型', '状态', 'Token', '成本', '算力', '延迟', '时间', '']} colAligns={['c','c','c','c','c','c','c','c','c','c','r']}>
        {d?.items.map(l => (
          <tr key={l.id}>
